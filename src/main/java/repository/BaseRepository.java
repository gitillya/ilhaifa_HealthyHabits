...
public abstract class BaseRepository<T> implements Repository<T> {
    ...
    //private static final String DB_URL = "jdbc:mysql://localhost:3306/ilhaifa_healthyhabits";
    private static final String DB_URL = "jdbc:mysql://127.0.0.1:3306/ilhaifa_healthyhabits";
    //private static final String USER = "root";
    private static final String USER = "ilhaifa_root";
    ...
    protected Connection openConnection() {
    	try {
			Class.forName("com.mysql.jdbc.Driver");  // special for eclipse
